export const ENGLISH_WEBVIEW_MESSAGES = {
  ...
  reasoning: 'Reasoning',
  agent: 'Agent',
  apiKeyRequired: 'Choose an API source and configure its Base URL and API Key in Connection settings.',
  configure: 'Configure',
  ...
  providerVisionModels: 'Image-capable model IDs',
  providerVisionModelsPlaceholder: 'qwen2.5-vl, custom-vision-model',
  providerVisionModelsHint: 'Comma-separated subset of Model IDs. IDs containing vision, image, vl, or multimodal are detected automatically.',
  providerMaxReasoningEffort: 'Maximum reasoning effort',
  providerReasoningLow: 'Low',
  providerReasoningHigh: 'High',
  providerReasoningMax: 'Maximum',
  providerReasoningHint: 'The message composer offers Off and every reasoning level through this maximum.',
